...
abstract class AppLocalizations {
  ...
  /// No description provided for @deposit_timeframe.
  ///
  /// In en, this message translates to:
  /// **'Instant'**
  String get deposit_timeframe;

  /// No description provided for @balance_reverted.
  ///
  /// In en, this message translates to:
  /// **'{currency} balance'**
  String balance_reverted(Object currency);

  /// No description provided for @convert_before_withdraw.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @convert_before_withdraw_again.
  ///
  /// In en, this message translates to:
  /// **'* For withdrawing your {convertFrom} you first need to convert it back to {convertTo}'**
